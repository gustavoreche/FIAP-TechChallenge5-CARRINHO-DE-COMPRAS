...
public class FinalizaCarrinhoSteps {
    ...
    public void queFinalizoUmCarrinhoQueEstejaDisponivelParaPagamento() {
    ...
    public void queFinalizoUmCarrinhoQueJaEstejaFinalizado() {
    ...
    public void queFinalizoUmCarrinhoQueNaoExiste() {
    ...
    public void queFinalizoUmCarrinhoComUmUsuarioQueNaoExisteNoSistema() {
        this.ean = System.currentTimeMillis();
        this.token = JwtUtil.geraJwt();
    ...
    public void finalizoEsseCarrinho() {
        RestAssured.baseURI = "http://localhost:8082";
        this.response = given()
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                .header("Authorization", "Bearer " + this.token)
                .when()
                .put(URL_CARRINHO_FINALIZA);
    }

    @Entao("recebo uma resposta que o carrinho foi finalizado")
    public void receboUmaRespostaQueOCarrinhoFoiFinalizado() {
        this.response
                .prettyPeek()
                .then()
    ...
    public void receboUmaRespostaQueOCarrinhoNaoFoiFinalizado() {
        this.response
                .prettyPeek()
                .then()
